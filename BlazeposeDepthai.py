...
class BlazeposeDepthai:
    ...
    def recognize_pose(self, r, expected_pose, track):
        ...
        if expected_pose == "mountain":
            ...
            pose = POSES["downward_facing_dog"]
        ...
        diff_dict["RIGHT_HAND_HIP_ANGLE"] = pose["RIGHT_HAND_HIP_ANGLE"]-RIGHT_HAND_HIP_ANGLE
        diff_dict["RIGHT_LEG_ANGLE"] = pose["RIGHT_LEG_ANGLE"]-RIGHT_LEG_ANGLE
        diff_dict["LEFT_HIP_KNEE_ANGLE"] = pose["LEFT_HIP_KNEE_ANGLE"]-LEFT_HIP_KNEE_ANGLE
